...
namespace com.amtec.action
{
    class SocketClientHandler
    {
        ...
        private IQCForm IQCview;
        private FinishPorductionForm FPview;
        private UIDRelationUserReport UidView;
        ...
        public SocketClientHandler(UIDRelationUserReport view)
        {
            this.UidView = view;
        }

        public SocketClientHandler(IQCForm view)
        {
            this.IQCview = view;
        }

        public SocketClientHandler(FinishPorductionForm view)
        {
            this.FPview = view;
        }
