...
namespace com.amtec.action
{
    public class GetProductQuantity
    {
        ...
        public ProductEntity GetProductQty(int processLayer, string workorder, string stationNumber)
        {
            ...
            LogHelper.Info("begin api trGetProductQuantity (Station number:" + stationNumber + ",Process layer:" + processLayer + ",Workorder number:" + workorder + ")");
            int error = imsapi.trGetProductQuantity(sessionContext, stationNumber, processLayer, 0, workorderFilters, filterDataArray, productQuantityResultKeys, out productQuantityResultValues);
